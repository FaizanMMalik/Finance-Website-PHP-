...
<?php
      if (isset($_POST['submit'])) {
        ...
        $sql = "INSERT INTO `sale`(`assetsId`, `amount`, `date`,description,partnerId) VALUES ('$_POST[assets]','$_POST[amount]','$_POST[date]','$_POST[description]','$_POST[partner]')";
...
<div>
    ...
    <h2 style="color:yellow">Add Sale</h2>
    <form action="saleAdd.php" method="post" onsubmit="return submitData()">
...
?>
      ...
      <!--<label style='color:yellow'>Amount</label>-->
        <input type="number"  placeholder="Amount" style=" width: 80%;
    padding: 12px 20px;
    margin: 8px 0;
    box-sizing: border-box;" name="amount" required value="<?php if(isset($_POST['amount'])){echo $_POST['amount'];} else{echo "";}?>">
    ...
    padding: 12px 20px;
    margin: 8px 0;
    box-sizing: border-box;" placeholder="Description" cols="20" name="description" required></textarea>
      </div>
       <br><br>
